...
const linkAction = () =>{
	const navMenu = document.getElementById('nav-menu')
	//when we click on each nav__link, we remove tthe show-menu close
	navMenu.classList.remove('show-menu')
}
...
sr.reveal(`.home__name, .home__info,
		 ...
		 .contact__social, .contact__data, .services-list, .testimonials, .result, .brands`, {origin: 'left'})
sr.reveal(`.process__card, .projects__card`, {interval: 100 })
